...
export const projects: Project[] = [
  {
    ...
    description:
      "A document-processing pipeline for extracting structured information from scanned mortgage documents.",
    problem:
  ...
  },
  {
    ...
    description:
      "A full-stack agricultural and business platform built around real application workflows.",
    problem:
  ...
  },
  {
    ...
    description:
      "A logistics platform developed during an internship for practical business operations.",
    problem:
  ...
  },
  {
    ...
    description:
      "An expandable space for experiments with LLMs, RAG, agents, local models, tool calling, and automation.",
    problem:
  ...
  },
  {
    ...
    description:
      "A context-aware agent for personalized insurance policy recommendations.",
    problem:
  ...
  },
  {
    ...
    description:
      "A highly available AWS architecture for moving a monolithic deployment toward containerized services.",
    problem:
  ...
  },
  {
    ...
    description:
      "A Dockerized e-commerce platform with authentication, cart, payment integration, and a large product catalog.",
    problem:
